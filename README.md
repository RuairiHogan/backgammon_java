...
# \- Dice roll logging for debugging (`dice\_rolls.log`) :contentReference\[oaicite:0]{index=0}
...
# \- `dice\_rolls.log` :contentReference\[oaicite:1]{index=1}
...
# \- Logs dice roll outcomes into `dice\_rolls.log` for debugging :contentReference\[oaicite:2]{index=2}
